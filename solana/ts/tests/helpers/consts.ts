...
export const FEE_RECIPIENT_KEYPAIR = Keypair.fromSecretKey(
  Uint8Array.from([
    218, 184, 196, 85, 127, 167, 142, 79, 112, 55, 22, 186, 116, 23, 229, 169,
    36, 1, 33, 61, 235, 96, 25, 133, 183, 99, 89, 24, 100, 119, 100, 66, 251,
    20, 77, 204, 112, 10, 167, 95, 167, 141, 220, 85, 32, 211, 59, 212, 133,
    186, 35, 75, 75, 162, 151, 71, 21, 238, 99, 11, 26, 148, 214, 108,
  ])
);
export const ASSISTANT_KEYPAIR = Keypair.fromSecretKey(
  Uint8Array.from([
    6, 112, 202, 230, 28, 135, 194, 201, 165, 233, 109, 90, 195, 185, 51, 105,
    255, 225, 177, 154, 43, 10, 0, 59, 201, 47, 189, 223, 181, 251, 21, 78, 255,
    166, 192, 21, 92, 164, 150, 69, 71, 42, 217, 218, 227, 234, 135, 74, 169,
    232, 243, 64, 75, 70, 20, 224, 4, 172, 177, 42, 196, 193, 5, 54,
  ])
);
